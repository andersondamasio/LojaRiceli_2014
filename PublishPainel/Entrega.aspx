                    ...
                    <asp:ListView ID="ListViewEntrega" runat="server" DataSourceID="EntityDataSourceEntrega" DataKeyNames="ent_id,loj_id" InsertItemPosition="None" OnItemEditing="ListViewEntrega_ItemEditing">
                        <EditItemTemplate>
                            <tr style="background-color: blue">
                                ...
                                <td>
                                    <asp:Label ID="ent_nomeLabel" runat="server" Text='<%# Eval("ent_nome") %>' />
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="ent_cidadeLabel" runat="server" Text='<%# Eval("ent_cidade") %>' />
                                </td>
                                <td>
                                    <asp:Label ID="ent_estadoLabel" runat="server" Text='<%# Eval("ent_estado") %>' />
                                </td>
                                <td>
                            ...
                            <tr style="">
                                ...
                                <td colspan="7">
                                       Nome:
                                    <asp:TextBox ID="ent_idInicialTextBox" runat="server" MaxLength="30" Text='<%# Bind("ent_nome") %>' />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic" ControlToValidate="ent_idInicialTextBox" SetFocusOnError="true" ValidationGroup="groupEdit" ErrorMessage="Campo obrigatório"></asp:RequiredFieldValidator><br/>
                                     Descrição:
                                    <asp:TextBox ID="ent_descricaoInicialTextBox" runat="server" MaxLength="120" Text='<%# Bind("ent_descricao") %>' /><br/>
                                    Cep de: 
                        ...
                        <InsertItemTemplate>
                            <tr style="">
                                <td colspan="7">
                                         Nome:
                                    <asp:TextBox ID="ent_idInicialTextBox" runat="server" MaxLength="30" Text='<%# Bind("ent_nome") %>' />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic" ControlToValidate="ent_idInicialTextBox" SetFocusOnError="true" ValidationGroup="groupInsert" ErrorMessage="Campo obrigatório"></asp:RequiredFieldValidator><br/>
                                     Descrição:
                                    <asp:TextBox ID="ent_descricaoInicialTextBox" runat="server" MaxLength="120" Text='<%# Bind("ent_descricao") %>' /><br/>
