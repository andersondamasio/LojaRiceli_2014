...
using Common.DirectoryServices;
...
namespace TesteConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //IISManager.CreateIISApplication("TESTEIIS", @"F:\SourceAnderson\Projetos\LojaRiceli_2014\WebForm\1-WebForm\App_Code\Cache");


           var xxxx =  IISManager.CreateUserSite("damasio", "riceli.com.br"); //AddHostHeader("127.0.0.1:80:user1.domain.com", IISManager.GetWebSiteId("localhost", "service.domain.com"));
            
            /*
                                                
            iis.DirectoryType = IISManager.VDirectoryType.WEB_IIS_DIR;
            iis.PhysicalPath = @"F:\SourceAnderson\Projetos\LojaRiceli_2014\WebForm\1-WebForm\App_Code\Cache"; 
            iis.ServerName = *""*/


            //CreateSite("IIS://Default Web Site/W3SVC", "555", "MySite", "D:\\Inetpub\\Wwwroot");
