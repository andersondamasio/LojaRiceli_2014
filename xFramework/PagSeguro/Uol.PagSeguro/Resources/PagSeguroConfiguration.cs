...
namespace Uol.PagSeguro.Resources
{
    ...
    public static class PagSeguroConfiguration
    {
        ...
        private static XmlDocument LoadXmlConfig()
        {
            ...
            string caminhoConfig = System.IO.Path.Combine(System.Web.HttpContext.Current.Request.PhysicalApplicationPath, "App_Code") + @"\Configuracoes\PagSeguroConfig.xml";
            //urlXmlConfiguration = caminhoConfig;
