...
namespace _2_Library.Dao.Site.ProdutoSkuX
{
    public class ProdutoSkuTd
    {
        ...
        /// <returns></returns>
        public ProdutoSkuDto SelectByProdutoSkuProdutoDetalhe(string loj_dominio, int proSku_id, int? ent_cep)
        {
                                             ...
                                             new
                                             {
                                                 ...
                                                 new ProdutoSkuCoresTamanhosDto
                                                 {
                                                     produtoSkuDto = new ProdutoSkuDto()
                                                     {
                                                         ...
                                                         entregaDto = Produto_GrupoUtils.VerificaEntrega(s3.entregaDto, ent_cep ?? 0),
                                              ...
                                              loj_id = loj_id,
                                              entregaDto = ent_cep.HasValue ? Produto_GrupoUtils.VerificaEntrega(proSkuTd.entregaDto, ent_cep.Value) : null,
       ...
       /// <returns></returns>
        ...
        {
            var produtos = (from proSkuDto in new ProdutoSkuTd().UpdateProdutoSkuRepoeQuantidadeDisponivel(loj_dominio, ped_id)
                            select new ProdutoSkuDto
                            {
                                pro_id = proSkuDto.pro_id,
                                proSku_nome = proSkuDto.proSku_nome
                            }).ToList();
