...
namespace _2_Library.Utils
{
    public class Validacao
    {
        ...
        /// <summary>
        /// adiciona script javascript correspondente a qualquer ação
        /// </summary>
        /// <param name="script">script em si</param>
        ...
        /// adiciona script javascript correspondente a qualquer ação
        /// </summary>
        /// <param name="key">chat correspondente ao ScriptManager</param>
        /// <param name="script">script em si</param>
        public static void SetScript(string key, string script)
        {
            System.Web.UI.Page page = new System.Web.UI.Page();
            var http = System.Web.HttpContext.Current;
            if ((http != null))
        ...
        /// <summary>
        /// adiciona script javascript entre as tags 'header' correspondente a qualquer ação
        /// </summary>
        /// <param name="script">script em si</param>
        public static void SetScriptHeader(string script)
        {
            System.Web.UI.Page page = new System.Web.UI.Page();
            var http = System.Web.HttpContext.Current;
            if ((http != null))
        ...
        /// <summary>
        /// adiciona uma refêrencia a um aquivo .js entre as tags 'header'
        /// </summary>
        /// <param name="script">caminho do arquivo .js</param>
        public static void AddPathScriptHeader(string path)
        {
            System.Web.UI.Page page = new System.Web.UI.Page();
            var http = System.Web.HttpContext.Current;
            if ((http != null))
        ...
        /// <summary>
        /// adiciona uma referência a um aquivo .css entre as tags 'header'
        /// </summary>
        /// <param name="script">caminho do arquivo .css</param>
        public static void AddPathStyleHeader(string path)
        {
            System.Web.UI.Page page = new System.Web.UI.Page();
            var http = System.Web.HttpContext.Current;
            if ((http != null))
