...
using _2_Library.Dao.ClienteEnderecoAdicionalX;
using _2_Library.Dao.Clientex;
using _2_Library.Dao.GatPagSeguroX;
using _2_Library.Dao.LojaX;
using _2_Library.Dao.StatusX;
            ...
            using (PedidoDao pedidoDao = new PedidoDao())
            {
                ...
                if (pedidoDto.ped_mensagemErro == null)
                {
                    ...
                    if (pedido.ped_forPag_gateway == "pagseguro" && pedido.ped_forPagPar_valor == 0)
                    {
                        ...
                        pedido.ped_forPagPar_valor = _2_Library.Dao.Produto_GrupoX.Produto_GrupoUtils.CalculaParcelamento(pedido.ped_forPagPar_quantidade, pedido.ped_forPagPar_percentualJuro, pedido.ped_total);
