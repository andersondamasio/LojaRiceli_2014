...
namespace _2_Library.Dao.GrupoX
{
    public class GrupoTd
    {
        ...
        /// <returns></returns>
        public IQueryable<Grupo> SelectGrupoInicial(string loj_dominio)
        {
        ...
        public string SelectGrupoCabecalho(string loj_dominio)
        {
            ...
            var result = (from grupo in produto_GrupoTd
                          select new
                          {
                              ...
                              grupo.gru_pai,
                              grupo.gru_posicao,
                          }).OrderBy(x => x.gru_id).OrderBy(s => s.gru_posicao).OrderBy(s2 => s2.gru_nome).ToList();
        ...
        public List<GrupoDto> SelectGrupoCaminho(string loj_dominio, string gru_nomeAmigavel)
        {
            ...
            List<GrupoDto> caminhoGrus = new Tratamento().ExtrairCaminhoGrupo(grupoTd);
            caminhoGrus.Reverse();
            return caminhoGrus;
        }
