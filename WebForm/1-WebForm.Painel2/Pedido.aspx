        ...
        <table width="1024px" align="center">
            <tr>
                <td>
                    ...
                    <asp:UpdatePanel ID="UpdatePanelPedidoStatus" runat="server">
                        <ContentTemplate>
                            <asp:ListView ID="ListViewPedidos" runat="server" Style="width: 100%" DataSourceID="EntityDataSourcePedidos" DataKeyNames="ped_id,loj_id" OnSelectedIndexChanging="ListViewPedidos_SelectedIndexChanging" OnPagePropertiesChanging="ListViewPedidos_PagePropertiesChanging">
                                <EmptyDataTemplate>
                                ...
                                <ItemTemplate>
                                    <tr style="border: 2px solid black">
                                        ...
                                        <td>
                                            <asp:Label ID="ped_forPag_situacaoLabel" runat="server" Text='<%# Eval("ped_forPag_situacao") %>' Font-Bold='<%# (string)Eval("ped_forPag_situacao") == "Paga" %>' />
                                        </td>
                                        <td>
                                ...
                                <SelectedItemTemplate>
                                    <tr style="background-color: #669999 !important;">
                                        <td>
                                            <asp:Label ID="ped_idLabel" runat="server" Text='<%# Eval("ped_id") %>' />
                                        </td>
                                        <td>
                                            ...
                                            <td runat="server">
                                                <table id="itemPlaceholderContainer" runat="server" border="1" style="" width="100%">
                                                    <tr runat="server" style="">
                                                        ...
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton3" Text="Cód." CommandName="Sort" CommandArgument="ped_id" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton1" Text="DataHora" CommandName="Sort" CommandArgument="ped_dataHora" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton2" Text="Email" CommandName="Sort" CommandArgument="ped_cli_email" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton4" Text="CpfCnpj" CommandName="Sort" CommandArgument="ped_cli_cpfCnpj" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton5" Text="Nome" CommandName="Sort" CommandArgument="ped_cli_nome" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton6" Text="Cidade" CommandName="Sort" CommandArgument="ped_cli_cidade" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton7" Text="Uf" CommandName="Sort" CommandArgument="ped_cli_estado" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton8" Text="FormaPag." CommandName="Sort" CommandArgument="ped_forPag_nome" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton9" Text="Total" CommandName="Sort" CommandArgument="ped_total" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton10" Text="Status" CommandName="Sort" CommandArgument="stat_nome" /></th>
                                                        <th runat="server">
                                                            <asp:LinkButton runat="server" ID="LinkButton11" Text="Situação" CommandName="Sort" CommandArgument="ped_forPag_situacao" /></th>
                                                        <th></th>
                                                    </tr>
                            ...
                            <asp:DataPager ID="DataPagerPedidos" runat="server" PageSize="10" PagedControlID="ListViewPedidos">
                                <Fields>
                            ...
                            <asp:EntityDataSource ID="EntityDataSourcePedidos" runat="server" ConnectionString="name=LojaEntities"
                                ...
                                Select="it.[ped_id],it.[loj_id],it.[ped_cli_nome],it.[ped_cli_sobreNome], it.[ped_cli_cpfCnpj], it.[ped_cli_email],
             it.[ped_cli_cidade], it.[ped_cli_estado], it.[ped_forPag_nome], it.[ped_forPagPar_quantidade], it.[ped_forPagPar_valor],
             it.[ped_subTotal], it.[ped_descontos], it.[ped_total], it.[ped_dataHora], DEREF(NAVIGATE(it, LojaModel.FK_Pedido_Status)).stat_nome,it.[usu_id],it.[ped_forPag_situacao]"
                ...
                <asp:Label ID="ped_enderecoIpLabel" runat="server" Text='<%# Bind("ped_enderecoIp") %>' />
                                    <br />
                                      <%# (((_2_Library.Modelo.Pedido)Container.DataItem).usu_id.HasValue ? "<b>Compra efetuada pelo USUÁRIO:"+new _2_Library.Dao.Painel.UsuarioX.UsuarioTd().SelectUsuario(null, ((_2_Library.Modelo.Pedido)Container.DataItem).usu_id.Value).usu_nome+"</b>" : "Compra efetuada pelo Cliente")%>
                                    <br />
                ...
                <asp:Label ID="ped_ent_valorLabel" runat="server" Text='<%# Bind("ped_ent_valor","{0:N}") %>' />
                                                <br />
                                                Rastreio:
                                                <a style="text-decoration:underline;cursor:pointer" onclick="this.innerHTML == '---' ? alert('Rastreio não encontrado') : AbrirJanela('http://websro.correios.com.br/sro_bin/txect01$.QueryList?P_LINGUA=001&P_TIPO=001&P_COD_UNI=<%# Eval("ped_ent_rastreio") %>', 400, 400);"><%# Eval("ped_ent_rastreio") ?? "---"%></a> <input id="ButtonEditarRastreio" type="button" value="Editar" onclick="document.getElementById('ped_ent_rastreio').style.display = '', document.getElementById('ButtonEditarRastreio').style.display = 'none'" />
                                                <span id="ped_ent_rastreio" style="display:none">
                                                   <asp:TextBox ID="ped_ent_rastreioTextBox" runat="server"></asp:TextBox>
                                                   <asp:Button ID="ButtonSalvarRastreio" runat="server" Text="Salvar" OnClick="ButtonSalvarRastreio_Click" />
                                                   <asp:Button ID="ButtonRemoverRastreio" runat="server" Text="Remover" OnClientClick="return confirm('Tem certeza que deseja remover o rastreio?');" OnClick="ButtonRemoverRastreio_Click" />
                                                   <input id="ButtonCancelarRastreio" type="button" value="Cancelar" onclick="document.getElementById('ped_ent_rastreio').style.display = 'none', document.getElementById('ButtonEditarRastreio').style.display = ''" />
                                                </span>
                                           </td>
                                            <td>
                ...
                <asp:Label ID="ped_forPag_percentualDescontoLabel" runat="server" Text='<%# Bind("ped_forPag_percentualDesconto") %>' />
                                                <br />
                                                Situação:<asp:Label ID="ped_forPag_situacaoLabel" runat="server" Text='<%# Bind("ped_forPag_situacao") %>' />
                                                 <asp:DropDownList ID="DropDownListSituacao" runat="server" Visible="false" SelectedValue='<%# Bind("ped_forPag_situacao") %>'>
                                                    <asp:ListItem>Pendente</asp:ListItem>
                                                    <asp:ListItem>Aguardando pagamento</asp:ListItem>
                                                    <asp:ListItem>Em análise</asp:ListItem>
                                                    <asp:ListItem>Paga</asp:ListItem>
                                                    <asp:ListItem>Disponível</asp:ListItem>
                                                    <asp:ListItem>Em disputa</asp:ListItem>
                                                    <asp:ListItem>Devolvida</asp:ListItem>
                                                    <asp:ListItem>Cancelada</asp:ListItem>
                                                    <asp:ListItem>Aguardando</asp:ListItem>
                                                    <asp:ListItem>Prazo expirou</asp:ListItem>
                                                </asp:DropDownList><asp:Button ID="ButtonAlterarSituacao" runat="server" Visible="false" Text="Salvar" OnClick="ButtonAlterarSituacao_Click" />
                                                <br />
                                            </td>
                                            <td>
                ...
                <asp:Label ID="ped_totalLabel" runat="server" Text='<%# Bind("ped_total","{0:N}") %>' />
                            ...
                            <asp:EntityDataSource ID="EntityDataSourceFormPedidos" runat="server" ConnectionString="name=LojaEntities" DefaultContainerName="LojaEntities"
                                ...
                                <WhereParameters>
                                    <asp:ControlParameter ControlID="ListViewPedidos" Name="loj_id" Type="Int32" PropertyName="SelectedDataKey.Values[loj_id]" />
