...
namespace Loja.Utils
{
    public static class Recursos
    {
       ...
       /* public static void Autenticar(_2_Library.Dao.UsuarioX.UsuarioDto usuarioDto)
        {
            FormsAuthentication.SetAuthCookie(HttpContext.Current.Server.HtmlEncode(usuarioDto.usu_nome), false);
            HttpCookie authCookie = FormsAuthentication.GetAuthCookie(usuarioDto.usu_nome, false);
            FormsAuthenticationTicket ticket = FormsAuthentication.Decrypt(authCookie.Value);
            string userData = usuarioDto.usu_id + "|";
