...
namespace Loja.Painel
{
    public partial class Entrega : System.Web.UI.Page
    {
        ...
        {
            if (!new EntregaConsulta().SelecionarEntregaExiste(((_2_Library.Modelo.Entrega)e.Entity).ent_cepInicial, ((_2_Library.Modelo.Entrega)e.Entity).ent_cepFinal, ((_2_Library.Modelo.Entrega)e.Entity).ent_prazo, ((_2_Library.Modelo.Entrega)e.Entity).ent_valor, 0))
            {
                ...
                ((_2_Library.Modelo.Entrega)e.Entity).loj_id = new _2_Library.Dao.LojaX.LojaTd().SelectLoja(null).loj_id;
                ((_2_Library.Modelo.Entrega)e.Entity).ent_dataHora = DateTime.Now;
            }
            else
            {
                e.Cancel = true;
                Validacao.Alert( "Faixa de Cep, Prazo e Valor já está cadastrada.");
            }
        }
        ...
        {
            if (!new EntregaConsulta().SelecionarEntregaExiste(((_2_Library.Modelo.Entrega)e.Entity).ent_cepInicial, ((_2_Library.Modelo.Entrega)e.Entity).ent_cepFinal, ((_2_Library.Modelo.Entrega)e.Entity).ent_prazo, ((_2_Library.Modelo.Entrega)e.Entity).ent_valor,((_2_Library.Modelo.Entrega)e.Entity).ent_id))
            {
