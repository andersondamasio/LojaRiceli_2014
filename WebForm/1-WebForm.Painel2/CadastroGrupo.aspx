<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastroGrupo.aspx.cs"
    Inherits="Loja.Painel.CadastroGrupo" Theme="" %>
                ...
                <td>
                    ...
                    <table border="2">
                        <tr>
                            ...
                            <td id="tdCadastro" style="position: relative; width: 95%; z-index: 1; vertical-align: top; max-width: 300px">
                                <link href="css/CadastroGrupo.css" type="text/css" rel="stylesheet" />
                    ...
                    <asp:Button ID="ButtonSalvarGrupo" runat="server" Text="Salvar" OnClick="ButtonSalvarGrupo_Click"
                        ValidationGroup="groupCadastrarGrupo" OnClientClick="return DesabilitarDuploClick(this,'Carregando...','groupCadastrarGrupo', true);" />
                                ...
                                <asp:Panel ID="PanelListarProduto" runat="server" Visible="false">
                                    <asp:ListView ID="ListViewProduto" runat="server" DataSourceID="ObjectDataSourceProduto_Grupo"
                                        ...
                                        <ItemTemplate>
                                            <tr style="text-align: left">
                                                ...
                                                <td>
                                                    <asp:Label ID="pro_nomeLabel" runat="server" Text='<%# Eval("produtoDto.pro_nome") %>' />
                                                </td>
                                                <td>
                                                    <%# Eval("produtoDto.produtoSkuDtoCount")%> sku(s)
                                                </td>
                                                <td>
                                                    <asp:CheckBox ID="Label1" runat="server" Checked='<%# Eval("produtoDto.pro_bloquear") %>' Enabled="false" />
                                                </td>
                                                <td>
                                        ...
                                        <SelectedItemTemplate>
                                            <tr style="background-color: Aqua; text-align: left">
                                                ...
                                                <td>
                                                    <%# Eval("produtoDto.produtoSkuDtoCount")%>
                                    sku(s)
                                                </td>
                                                <td>
                                                    <asp:CheckBox ID="Label1" runat="server" Checked='<%# Eval("produtoDto.pro_bloquear") %>' Enabled="false" />
                                    ...
                                    <asp:ObjectDataSource ID="ObjectDataSourceProduto_Grupo" runat="server"
                                        SelectMethod="SelectProduto_GrupoListar"
                                        TypeName="_2_Library.Dao.Painel.Produto_GrupoX.Produto_GrupoTd"
                                        EnablePaging="True" SelectCountMethod="SelectProduto_GrupoListarCount" SortParameterName="orderBy">
                                        <SelectParameters>
                    ...
                    <asp:TextBox ID="pro_paginaInicialDataDeTextBox" runat="server" Columns="10" MaxLength="10" />
                                    -
                                    <asp:DropDownList ID="pro_paginaInicialHoraDeDropDownList" runat="server">
                                        ...
                                        <asp:ListItem Value="24:00:00">24:00</asp:ListItem>
                                    </asp:DropDownList>

                                    até:
                    <asp:TextBox ID="pro_paginaInicialDataAteTextBox" runat="server" Columns="10" MaxLength="10" />
                                    -
                                    <asp:DropDownList ID="pro_paginaInicialHoraAteDropDownList" runat="server">
                                        <asp:ListItem></asp:ListItem>
                                        <asp:ListItem Value="00:00:00">00:00</asp:ListItem>
                                        <asp:ListItem Value="01:00:00">01:00</asp:ListItem>
                                        <asp:ListItem Value="02:00:00">02:00</asp:ListItem>
                    ...
                    <asp:CheckBox ID="pro_bloquearCheckBox" runat="server" />
                                ...
                                <asp:Panel ID="PanelListarProdutoSku" runat="server" Visible="false">
                                    ...
                                    <asp:ListView ID="ListViewProdutoSku" runat="server" DataSourceID="ObjectDataSourceProdutoSku"
                                        ...
                                        <ItemTemplate>
                                            <tr style="text-align: left">
                                                ...
                                                <td>
                                                    <asp:Label ID="Label6" runat="server" Text='<%# Eval("produtoSkuCorDto.proSkuCor_nome") %>' />
                                                </td>
                                                <td>
                                                    <asp:Label runat="server" Text='<%# Eval("produtoSkuTamanhoDto.proSkuTam_nome") %>' />
                                                </td>
                                                <td>
                                                    <img src="http://<%= HttpContext.Current.Request.Url.Host+HttpContext.Current.Request.ApplicationPath.ToLower().Replace("painel",string.Empty) %>/imagens/produtos/cores/<%# Eval("produtoSkuCorDto.proSkuCor_nome") %>" onerror="this.style.display = 'none'" />
                                                </td>
                                                <td>
                                                    <%# (Boolean)Eval("proSku_disponivel") == false || (Boolean)Eval("proSku_bloquear") == true || (int)(!((int?)Eval("proSku_quantidadeDisponivel")).HasValue ? 1 : Eval("proSku_quantidadeDisponivel")) == 0 ? "<img src=\"imagens/bloqueadoVenda.png\" />" : "<img src=\"imagens/desbloqueadoVenda.png\" />"%>
                                                </td>
                                                <td>
                                                    <%# Eval("proSku_posicao") %>
                                                </td>
                                        ...
                                        <SelectedItemTemplate>
                                            <tr style="background-color: Aqua; text-align: left">
                                                ...
                                                <td>
                                                    <asp:Label ID="Label5" runat="server" Text='<%# Eval("produtoSkuCorDto.proSkuCor_nome") %>' />
                                                </td>
                                                <td>
                                                    <asp:Label runat="server" Text='<%# Eval("produtoSkuTamanhoDto.proSkuTam_nome") %>' />
                                                </td>
                                    ...
                                    <asp:DataPager ID="DataPager2" runat="server" PageSize="20" PagedControlID="ListViewProdutoSku">
                                     ...
                                     <asp:ObjectDataSource ID="ObjectDataSourceProdutoSku" runat="server"
                                        SelectMethod="SelectProdutoSkuListar"
                                        TypeName="_2_Library.Dao.Painel.ProdutoSkuX.ProdutoSkuTd"
                                        EnablePaging="True" SelectCountMethod="SelectProdutoSkuListarCount" SortParameterName="orderBy">
                                        <SelectParameters>
                                            <asp:Parameter Name="loj_dominio" Type="String" />
                    ...
                    <asp:CheckBox ID="proSku_destaqueCheckBox" runat="server" Text="sim" />
                                    <br />
                                    Entrega:<asp:DropDownList ID="proSku_entregaDropDownList" runat="server" DataTextField="ent_nome"
                                        DataValueField="ent_id" AppendDataBoundItems="True">
                                    ...
                                    <asp:LinkButton ID="LinkButtonAtualizarParcelamento" runat="server" OnClick="LinkButtonAtualizarParcelamento_Click">Atualizar</asp:LinkButton>&nbsp; <a href="CadastroParcelamento.aspx" target="_blank">Cadastrar</a>
                            ...
                            <asp:Button ID="ButtonEnviarProdutoSkuFoto" runat="server" Text="Enviar Foto" OnClick="ButtonEnviarProdutoSkuFoto_Click" ValidationGroup="groupEnviarProdutoSkuFoto" OnClientClick="return DesabilitarDuploClick(this,'Enviando...','groupEnviarProdutoSkuFoto', true);" />
                                    ...
                                    <asp:ListView ID="ListViewProdutoSkuFoto" runat="server" DataSourceID="EntityDataSourceProdutoSkuFoto"
                                        ...
                                        <ItemTemplate>
                                            <tr style="">
                                                <td>
                                                    <img src="http://<%= HttpContext.Current.Request.Url.Host+HttpContext.Current.Request.ApplicationPath.ToLower().Replace("painel",string.Empty) %>/imagens/produtos/fotos/<%= new _2_Library.Dao.LojaX.LojaTd().SelectLoja(null).loj_id + "/" + ListViewProduto.SelectedValue %>/<%# Eval("proSkuFot_nome") %>-m<%# Eval("proSkuFot_extensao") %>" style="max-height: 40px" />
                                                </td>
                                                <td>
