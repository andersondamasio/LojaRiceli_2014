            ...
            <tr>
                <td>
                    ...
                    <asp:ListView ID="ListViewLoja" runat="server" DataKeyNames="loj_id" DataSourceID="EntityDataSourceLoja"
                         InsertItemPosition="None" OnItemEditing="ListViewLoja_ItemEditing" OnItemUpdated="ListViewLoja_ItemUpdated" OnItemUpdating="ListViewLoja_ItemUpdating">
                        <EditItemTemplate>
                            <tr style="background-color: blue">
                              ...
                              <td>
                                    <asp:CheckBox ID="Label1" runat="server" Checked='<%# Eval("loj_bloquear") %>' Enabled="false" />
                                </td>
                                <td>
                    ...
                    <asp:Button ID="ButtonIncluirLoja" runat="server" Text="Incluir Loja" OnClick="ButtonIncluirLoja_Click" />
                     ...
                     <asp:EntityDataSource ID="EntityDataSourceLoja" runat="server" ConnectionString="name=LojaEntities"
                        ...
                        OnInserted="EntityDataSourceLoja_Inserted" OnInserting="EntityDataSourceLoja_Inserting" OnUpdated="EntityDataSourceLoja_Updated" OnUpdating="EntityDataSourceLoja_Updating" OnDeleted="EntityDataSourceLoja_Deleted">
