...
namespace Loja.Painel
{
    public partial class ConfiguracaoPedidoStatus : System.Web.UI.Page
    {
        ...
        {
            ((_2_Library.Modelo.Status)e.Entity).loj_id = Loja.Modelo.Lojax.LojaConsulta.SelecionarLojaDominio().loj_id;
        ...
        protected void EntityDataSourcePedidoStatus_Deleting(object sender, EntityDataSourceChangingEventArgs e)
        {
            ...
            {
                Loja.Utils.Validacao.Alert(Page, "Não é possível excluir um status quando ele já está vinculado a algum pedido.");
                e.Cancel = true;
            }
        }
        ...
        protected void ListViewPedidoStatus_ItemDeleting(object sender, ListViewDeleteEventArgs e)
        {
            ...
            {
                Loja.Utils.Validacao.Alert(Page, "Não é possível excluir um Status Padrão.");
                e.Cancel = true;
            }
        }
    }
