<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Loja.Views.Login" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="1">
            ...
            <tr>
                <td>
                    <asp:Button ID="ButtonEntrarFinalizar" runat="server" Text="Entrar e Finalizar" ValidationGroup="validGroupLogin" OnClick="ButtonEntrarFinalizar_Click" OnClientClick="return DesabilitarDuploClick(this,'Validando seu usuário...','validGroupLogin', true);" /></td>
                <td>
                    <asp:Button ID="ButtonCadastrarFinalizar" runat="server" Text="Cadastrar e Finalizar" ValidationGroup="validGroupCadastroNovo" OnClientClick="return DesabilitarDuploClick(this,'Carregando...','validGroupCadastroNovo', true);" OnClick="ButtonCadastrarFinalizar_Click" /></td>
            </tr>
        </table>
