<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdutoBusca.aspx.cs" Inherits="_1_WebForm.ProdutoBusca" %>
    ...
    <form id="form1" runat="server">
        <div>
                    ...
                    <nav id="menuLateral">
                        ...
                        <asp:Panel runat="server" ID="PanelFiltroLimpar">
                            ...
                            <asp:Repeater ID="RepeaterProdutoSkuTamanhoLimpar" runat="server" DataSource='<%# _2_Library.Utils.Tratamento.FiltroTamanhoLimparList((string)RouteData.Values["proSku_tamanhos"]) %>' EnableViewState="false">
                                ...
                                <ItemTemplate>
                                    <div>
                                        <%# Container.DataItem.ToString()  %> - <a href="<%# Page.GetRouteUrl("ProdutoBusca", null)+_2_Library.Utils.Tratamento.FiltroTamanhoLimparRemover((string)RouteData.Values["proSku_tamanhos"],(string)RouteData.Values["proSku_cores"],Container.DataItem.ToString())+"?q="+HttpContext.Current.Request.QueryString["q"] %>">...........Limpar</a>
                                    </div>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <br />
                            ...
                            <asp:Repeater ID="RepeaterProdutoSkuCorLimpar" runat="server" DataSource='<%# _2_Library.Utils.Tratamento.FiltroCorLimparList((string)RouteData.Values["proSku_cores"]) %>' EnableViewState="false">
                                ...
                                <ItemTemplate>
                                    <div>
                                        <%# Container.DataItem.ToString()  %> - <a href="<%# Page.GetRouteUrl("ProdutoBusca", null)+_2_Library.Utils.Tratamento.FiltroCorLimparRemover((string)RouteData.Values["proSku_cores"],(string)RouteData.Values["proSku_tamanhos"],Container.DataItem.ToString())+"?q="+HttpContext.Current.Request.QueryString["q"] %>">...........Limpar</a>
                                    </div>
                                </ItemTemplate>
                            </asp:Repeater>
                        </asp:Panel>
                        ...
                        <div id="AlteraTamanho">
                            <asp:Panel ID="PanelProdutoSkuTamanhoLimparFiltros" runat="server" CssClass="LimparFiltros">
                                <a href="<%= Page.GetRouteUrl("ProdutoBusca", null) %><%= _2_Library.Utils.Tratamento.FiltroLimparTudo((string)RouteData.Values["proSku_cores"],string.Empty)+"?q="+HttpContext.Current.Request.QueryString["q"] %>">Limpar selecionados</a>
                            </asp:Panel>
                                ...
                                <asp:Repeater ID="RepeaterProdutoSkuTamanho" runat="server">
                                    <ItemTemplate>
                                        ...
                                        <asp:Panel runat="server" ID="PanelTamanho2" Visible='<%# !_2_Library.Utils.Tratamento.FiltroTamanhoConsultada((string)RouteData.Values["proSku_tamanhos"],(string)Eval("proSkuTam_nome")) %>'>
                                            <a href="<%# Page.GetRouteUrl("ProdutoBusca", null)+_2_Library.Utils.Tratamento.FiltroTamanho((string)RouteData.Values["proSku_tamanhos"],(string)RouteData.Values["proSku_cores"],(string)Eval("proSkuTam_nome")) +"?q="+HttpContext.Current.Request.QueryString["q"] %>">
                        ...
                        <div id="AlteraCor">
                            <asp:Panel ID="PanelProdutoSkuCorLimparFiltros" runat="server" CssClass="LimparFiltros">
                                <a href="<%= Page.GetRouteUrl("ProdutoBusca", null) %><%= _2_Library.Utils.Tratamento.FiltroLimparTudo(string.Empty,(string)RouteData.Values["proSku_tamanhos"])+"?q="+HttpContext.Current.Request.QueryString["q"]%>">Limpar selecionados</a>
                            </asp:Panel>
                            <div class="rolagem">
                                <asp:Repeater ID="RepeaterProdutoSkuCor" runat="server">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Panel runat="server" ID="PanelCor2" CssClass="clear" Style="cursor: pointer" Visible='<%# !_2_Library.Utils.Tratamento.FiltroCorConsultada((string)RouteData.Values["proSku_cores"],(string)Eval("proSkuCor_nome")) %>'>
                                            <a href="<%# Page.GetRouteUrl("ProdutoBusca", null)+_2_Library.Utils.Tratamento.FiltroCor((string)RouteData.Values["proSku_cores"],(string)RouteData.Values["proSku_tamanhos"],(string)Eval("proSkuCor_nome")) +"?q="+HttpContext.Current.Request.QueryString["q"]%>">
                    ...
                    <div id="conteudo">
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSourceGrupoCaminho" runat="server"
                            ...
                            <SelectParameters>                         
                                ...
                                <asp:RouteParameter Name="gru_nomeAmigavel" RouteKey="gru_nomeAmigavel" Type="String" />
                            </SelectParameters>
                            ...
                            <ItemTemplate>
                                <div class="produto">
                                    <asp:Repeater ID="RepeaterProdutoGrupoConteudo" runat="server" DataSource='<%# Eval("produtoSkuDto")%>'>
                                        <ItemTemplate>
                                            <div id='divProSkuConteudo<%# Eval("pro_id") %><%# Eval("proSku_id") %>' style="display: none">
                                                ...
                                                <a href="<%= Page.GetRouteUrl("PaginaInicial", null) %><%# Eval("gru_nomeAmigavel") %><%# Eval("pro_nomeAmigavel") %>">
                                                    <asp:Panel ID="PanelProdutoSkuComFoto" runat="server" Visible='<%# (Eval("produtoSkuFotoDto") != null) %>'>
                                                        <img src="<%= Page.GetRouteUrl("PaginaInicial", null) %>imagens/produtos/fotos/<%# Eval("loj_id") %>/<%# Eval("pro_id") %>/<%# Eval("produtoSkuFotoDto.proSkuFot_nome") %>-v<%# Eval("produtoSkuFotoDto.proSkuFot_extensao") %>" />
                                                    </asp:Panel>
                                                    <asp:Panel ID="PanelProdutoSkuSemFoto" runat="server" Visible='<%# !(Eval("produtoSkuFotoDto") != null) %>'>
                                                        <img src="<%= Page.GetRouteUrl("PaginaInicial", null) %>imagens/produtos/fotos/<%# Eval("loj_id") %>/sem-foto/sem-foto.jpg" height="232" width="160" />
                                                    </asp:Panel>
                                                ...
                                                <asp:Panel ID="PanelProdutoSkuPreco" runat="server" Visible='<%# (Boolean)Eval("proSku_disponivel") %>'>
                                                    ...
                                                    <asp:Panel runat="server" ID="PanelParcelamentoSku" CssClass="produto_parcelas" Visible='<%#  !(bool)Eval("parcelamentoDto.parc_bloquear") %>'>
                                                         <asp:Repeater ID="RepeaterProdutoSkuParcelamentoParcela" runat="server" DataSource='<%# ((List<_2_Library.Dao.Site.Produto_GrupoX.ParcelamentoParcelaDto>)Eval("parcelamentoDto.parcelamentoParcelaDto")).OrderByDescending(s=>s.parcPar_quantidade).Take(1) %>'>
                                                                <ItemTemplate>                                                                          
                                                                    em até <%# Eval("parcPar_quantidade") %>x 
                                                                    R$ <%# Eval("parcPar_valor","{0:N}") %>
                                                                </ItemTemplate>
                                                            </asp:Repeater>
                                                        <%# (Boolean)Eval("parcelamentoDto.parc_ativarJuro") ? string.Empty : "sem juros" %>
                                                    </asp:Panel>
                                    ...
                                    <asp:Repeater ID="RepeaterProdutoGrupoCor" runat="server" DataSource='<%# Eval("produtoSkuDto")%>'>
                                        <ItemTemplate>
                                            <span id='divCor<%# Eval("proSku_id") %>'>
                                                <img id='proSkuCor' title="escolher cor <%# Eval("proSkuCor_nome") %>" onload="if(<%#Container.ItemIndex%> == 0)SelecionaProSkuCor('<%# Eval("pro_id") %>','<%# Eval("proSku_id") %>')" onerror="SelecionaProSkuCorOnError(this);" onmouseover="SelecionaProSkuCor('<%# Eval("pro_id") %>','<%# Eval("proSku_id") %>')" src="<%= Page.GetRouteUrl("PaginaInicial", null) %>imagens/produtos/cores/<%# Eval("proSkuCor_imagem") %>" style="margin: 3px; cursor: pointer" /></span>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceProduto_Grupo" runat="server"
                SelectMethod="SelectProduto_GrupoProdutoBusca" TypeName="_2_Library.Dao.Site.Produto_GrupoX.Produto_GrupoTd"
                EnablePaging="True" SelectCountMethod="SelectProduto_GrupoProdutoBuscaCount" OnSelecting="ObjectDataSourceProduto_Selecting">
                <SelectParameters>
                    <asp:Parameter Name="loj_dominio" Type="String" />
                      <asp:QueryStringParameter Type="String" QueryStringField="q" Name="pro_nomeChave" />
